...
export const render = async function (path, params, cfg) {
  ...
  let { render, e } = cfg;
  let _layout_path = process.cwd() + "/plugins/windoge-plugin/resources/";
  let layout_path= process.cwd() + "/plugins/windoge-plugin/resources/common/layout/";
  let base64 = await render(paths[0], paths[1], {
    ...params,
    _layout_path,
	 _tpl_path: process.cwd() + '/plugins/windoge-plugin/resources/common/tpl/',
